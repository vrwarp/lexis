...
- Support context: `notes/master_glossary.json`, `notes/style_guide.md`, `notes/metadata.json`, `notes/contents.json`, and the section summary `notes/<original file>.summary.txt`.
